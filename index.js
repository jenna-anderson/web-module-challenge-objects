...
console.log(createMenuItem('sandwich', '14', 'lunch'));
...
*/
reviews.push({name: "Kali", rating: 5, feedback: "friendly staff and delicious food"});
console.log(reviews);
...
function getLongReviews(reviewArray) {
  ...
  let feedbackWords = [];
    for(let i = 0; i < reviewArray.length; i++){
      feedbackWords = reviewArray[i].feedback.split(" ");
      if(feedbackWords.length > 15){
